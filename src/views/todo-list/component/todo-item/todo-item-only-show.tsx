...
import { MarkdownShow, TodoItemType, TodoStatus, splitMdStr, splitStr } from "@xiaxiazheng/blog-libs";
...
/** todo 专用，有详细描述或图片或文件时，才展示 tooltip */
...
const TodoItemName: React.FC<TodoItemNameProps> = (props) => {
    ...
    const { todoColorMap } = useSettings();
