...
import { handleUploadFile, UploadComponent, UploadType, handleComputedFileSize } from "@xiaxiazheng/blog-libs";

interface IProps {
    type: UploadType; // 图片在该系统中的类型的类型
            ...
            >
                {name ? (
                    <div className={styles.progress}>
                        ...
                        <div>{handleComputedFileSize(size || 0)}</div>
